...
cd /home/wsl/local_ubuntu/enviroment/platform/ec2-ubuntu/iac/cloud-formation
make deploy-eks
...
```bash
# k8sディレクトリに移動
cd /home/wsl/local_ubuntu/enviroment/platform/ec2-ubuntu/iac/cloud-formation/k8s
